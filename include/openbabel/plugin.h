...
#define OB_STATIC_PLUGIN(className,instanceName) \
  ...
  OB_STATIC_PLUGIN(OBForceFieldMMFF94GPU, theForceFieldMMFF94GPU)
  OB_STATIC_PLUGIN(OBForceFieldMMFF94GPU, theForceFieldMMFF94sGPU)

  OB_STATIC_PLUGIN(OBForceFieldMMFF94Eigen, theForceFieldMMFF94Eigen)
  OB_STATIC_PLUGIN(OBForceFieldMMFF94Eigen, theForceFieldMMFF94sEigen)
