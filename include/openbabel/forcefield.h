  ...
  */
  ...
  class OBFPRT OBForceField : public OBPlugin
  {
    ...
    */
    ...
    // This map in order to store information on time duration for energy calculations in forcefield methods
    std::map<std::string, double> timings;

    // This map holds information of the allocated memory for specific precomputed calculations during setup
  ...
  public:
    ...
    */
    ...
    std::map<std::string, double> getTimings(void) {
    	return timings; // it is empty unless you enter info here.
    }

    std::map<std::string, size_t> getAllocatedMemory(void) {
