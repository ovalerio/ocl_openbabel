...
int main(int argc,char **argv)
{
  ...
  if (argc < 2) {
    cout << "Usage: obminimize [options] <filename>" << endl << endl;
    cout << "options:      description:" << endl << endl;
    cout << "  -c crit     set convergence criteria (default=1e-6)" << endl << endl;
    cout << "  -cg         use conjugate gradients algorithm (default)" << endl << endl;
    cout << "  -sd         use steepest descent algorithm" << endl << endl;
    cout << "  -newton     use Newton2Num linesearch (default=Simple)" << endl << endl;
    cout << "  -ff ffid    select a forcefield:" << endl << endl;
    cout << "  -h          add hydrogen atoms" << endl << endl;
    cout << "  -n steps    specify the maximum numer of steps (default=2500)" << endl << endl;
    cout << "  -cut        use cut-off (default=don't use cut-off)" << endl << endl;
    cout << "  -rvdw rvdw  specify the VDW cut-off distance (default=6.0)" << endl << endl;
    cout << "  -rele rele  specify the Electrostatic cut-off distance (default=10.0)" << endl << endl;
    cout << "  -pf freq    specify the frequency to update the non-bonded pairs (default=10)" << endl << endl;
  ...
  for (c=1;;c++) {
    ...
    conv.Write(&mol, &cout);
    cerr << "Time: " << timeElapsed << "seconds. Steps: " << totalSteps << "Iterations per second: " <<  double(totalSteps) / timeElapsed << endl;
  } // end for loop
