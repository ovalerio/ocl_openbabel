...
//  eigen_sparsemat.reserver(Eigen::VectorXi::Constant(eigen_sparsemat.cols(), 4));
//  for each i,j such that v_ij != 0
//		  eigen_sparsemat.insert(i,j) = v_ij;
//  eigen_sparsemat.makeCompressed();
  eigen_sparsemat.startFill(5*2);
  eigen_sparsemat.fill(0,0) = 2.0;   eigen_sparsemat.internal::fill(0,1) = -1.0;
  eigen_sparsemat.fill(1,1) = 2.0;   eigen_sparsemat.internal::fill(1,2) = -1.0;
  eigen_sparsemat.fill(2,2) = -1.0;  eigen_sparsemat.internal::fill(2,3) = -1.0;
  eigen_sparsemat.fill(3,3) = 2.0;   eigen_sparsemat.internal::fill(3,4) = -1.0;
