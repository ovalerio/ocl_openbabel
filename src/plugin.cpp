...
std::vector<std::string> EnableStaticPlugins()
{
  ...
  plugin_ids.push_back(reinterpret_cast<OBPlugin*>(&theForceFieldMMFF94GPU)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin*>(&theForceFieldMMFF94sGPU)->GetID());

  plugin_ids.push_back(reinterpret_cast<OBPlugin*>(&theForceFieldMMFF94Eigen)->GetID());
  plugin_ids.push_back(reinterpret_cast<OBPlugin*>(&theForceFieldMMFF94sEigen)->GetID());
